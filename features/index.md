...
## Vergebene Feature-Nummern

| Nummer | Feature | Status | Anmerkung |
|--------|---------|--------|-----------|
...
1. **Keine Doppelung:** Niemals zwei Features mit gleicher Nummer anlegen
2. **Bei Erweiterungen:** Feature als Unterpunkt zum ursprünglichen Feature dokumentieren (nicht neue Nummer)
3. **Neue Features:** Immer die nächste freie Nummer verwenden
4. **Tracking:** Diese Datei nach jedem neuen Feature aktualisieren
