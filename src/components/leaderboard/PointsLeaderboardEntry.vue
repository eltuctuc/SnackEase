...
import type { PointsLeaderboardEntry } from '~/composables/useLeaderboard'
...
<template>
  <li
    :aria-label="`Rang ${entry.rank}: ${entry.name}, ${entry.location}, ${entry.totalPoints} Punkte`"
  ...
  >
    ...
    <div class="flex-shrink-0 text-right">
      <span class="text-sm font-bold text-gray-700">{{ entry.totalPoints }}</span>
      <span class="text-xs text-muted-foreground ml-1">Pkt.</span>
    </div>
  </li>
</template>
